...
def check_letter():
    letter = input("Enter a letter (a-z or A-Z) and determine is type:").lower()
...
def check_voting_eligibility():
    ...
    if age >= 21:
        ...
        print("You're not allowed to vote my guy")
...
def calculate_dog_years():
    ...
    if dogAge <=2 and dogAge >0:
        dogAge = 10 * dogAge
        print(f"The dog's age in dog years is {dogAge}")
    elif dogAge >= 2:
        dogAge = 20 + 7 * (dogAge-2) 
        print(f"The dog's age in dog years is {dogAge}")
    else:
        print(f"{dogAge} is a negative number please enter a valid number")
# Call the function
calculate_dog_years()
...
def determine_season():
    ...
    if (month == "dec" and day >= 21) or (month == "mar" and day < 20):
        season = "Winter"
    elif (month == "mar" and day >= 20) or (month == "jun" and day < 21):
        season = "Spring"
